...
// NOTE: initPolicyAreaFilter is defined in overview.js (populates dropdown options + handles change)

// NOTE: The following functions are defined in overview.js and app.js (loaded earlier):
// - openPolicyAreaSidePanel, closeSidePanel, initSidePanel → overview.js
// - initKeywordSearch, renderKeywordResults, highlightKeyword → overview.js
// - getShortAreaName, downloadFullCSV → app.js
